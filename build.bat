...
set _ASSIMP_DIR="C:\Users\klove\Documents\repos\GLFW2\Vulkan_Learning_Project\assimp\include"
...
set COMMON_INHERENT_LIB=glfw3.lib opengl32.lib gdi32.lib user32.lib shell32.lib ucrt.lib vcruntime.lib msvcrt.lib kernel32.lib assimp-vc143-mtd.lib
...
rem cl /LD ..\KPlatformG.cpp %COMMON_COMPILER_OPTION% /I %GLFW_INCLUDE_DIR% /link /LIBPATH:%GLFW_LIB_DIR% %COMMON_INHERENT_LIB% /PDB:platform_%dd%%mm%%yy%_%hr%%min%.pdb %_EXPORT% /OUT:Platform.dll

cl  ..\main.cpp ..\KPlatformG.cpp ..\C_Mesh.cpp ..\C_Model.cpp %COMMON_COMPILER_OPTION% /I %GLFW_INCLUDE_DIR% /I %_INCLUDE_DIR% /I %_ASSIMP_DIR% /link /subsystem:console /LIBPATH:%GLFW_LIB_DIR% /LIBPATH:%ASSIMP_LIB% %COMMON_INHERENT_LIB% /FORCE:MULTIPLE /IGNORE:4006 /subsystem:console /OUT:%OUT_EXE%
