...
set
VULKAN_INCLUDE_DIR="C:\VulkanSDK\1.4.304.1\Include"
set
VULKAN_LIB_DIR="C:\VulkanSDK\1.4.304.1\Lib"
set
VULKAN_INCLUDE_DLL="C:\VulkanSDK\1.4.304.1\Bin"
...
REM The reason why the compile the subsystem:consoles may solved the undebug problem.  /FORCE:MULTIPLE
cl %FILES% /FC /Zi /EHsc /I %GLFW_INCLUDE_DIR% %VULKAN_INCLUDE_DIR% /link /subsystem:console /IGNORE:4006 /LIBPATH:%GLFW_LIB_DIR% %VULKAN_LIB_DIR% glfw3.lib opengl32.lib gdi32.lib user32.lib shell32.lib ucrt.lib vcruntime.lib msvcrt.lib kernel32.lib /NODEFAULTLIB:LIBCMT /FORCE:MULTIPLE /DEBUG /OUT:%OUT_EXE%
